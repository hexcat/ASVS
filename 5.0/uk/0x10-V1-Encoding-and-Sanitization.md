...
| **1.3.7** | Перевірити, що застосунок захищений від атак template injection, не дозволяючи створювати шаблони на основі недовірених вхідних даних. Якщо альтернативи немає, будь-який недовірені вхідні дані, які динамічно включаються під час створення шаблону, повинні бути санітизовані або суворо валідовані. | 2 |
...
| **1.3.12** | Перевірити, що регулярні вирази не містять елементів, які викликають експоненціальний backtracking, а також забезпечити очищення недоверених вхідних даних для зменшення ризику атак типу ReDoS або Runaway Regex. | 3 |
...
| **1.4.2** | Перевірити, що застосовуються техніки перевірки знаку, діапазону та валідації вхідних даних для запобігання переповненню цілих чисел. | 2 |
